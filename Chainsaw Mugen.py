...
mixer.music.load("assets/blurred.wav")
mixer.music.play(-1)
...
def options():
    while True:
        ...
        KEY_BG = pygame.image.load("assets/keybinds bg.png")

        SCREEN.blit(KEY_BG, (0, 0))
        
        OPTIONS_TEXT = get_font(80).render("KEYBINDS", True, "Black")
        OPTIONS_RECT = OPTIONS_TEXT.get_rect(midtop=(640, 20))
        
        SCREEN.blit(OPTIONS_TEXT, OPTIONS_RECT)

        OPTIONS_BACK = Button(image=None, pos=(100, 35), 
...
def main_menu():
    while True:
        ...
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(640, 400), 
                            text_input="KEYBINDS", font=get_font(60), base_color="#fdfd96", hovering_color="White")
